...
AddRefuelingButton.forEach(Button => {
    ...
    Button.addEventListener('click', () => {
        ...
        AddRefuelingButton_X.addEventListener('click', () => {   
            ...
            } else if (Number(AddRefuelingForm.children[8].children[1].value) > Number(CarBalance_.value) && (AddRefuelingForm.children[6].children[1].value == CarCardNumber_.textContent)) {
