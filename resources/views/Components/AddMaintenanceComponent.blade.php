<div class="add-maintenance-form form">
    <div class="inner">
        <div class="error"></div>
        <div class="heading">
            <h1>
        ...
        <form class="AddMaintenanceForm">
            ...
            <div class="new-car-inputs">
                ...
                <input  type="text" list="VehicleNumbers" name="VehicleNumber_MAINTENANCE" placeholder="PLATE Number	..">
            ...
            <div class="new-car-inputs">
                ...
                <input  type="time" name="Time" step='any' value="{{ date('h:i') }}">
            </div>
            <div class="new-car-inputs">
                <div class="new-car-inputs-inner">
                ...
                <input  type="text" name="MaintenanceAction" placeholder="Maintenance Action	..">
            </div>
            <div class="new-car-inputs">
                <div class="new-car-inputs-inner">
                ...
                <input  type="date" name="ReleaseDate" value="{{ date('Y-m-d') }}">
            </div>
            <div class="new-car-inputs">
                <div class="new-car-inputs-inner">
                    <svg xmlns="http://www.w3.org/2000/svg" height="48" viewBox="0 96 960 960" width="48"><path d="M405 782h361V524H405v258ZM140 896q-24 0-42-18t-18-42V316q0-24 18-42t42-18h680q24 0 42 18t18 42v520q0 24-18 42t-42 18H140Zm0-60h680V316H140v520Zm0 0V316v520Z"></path></svg>
                ...
                <input  type="time" name="ReleaseTime" step='any' placeholder="Release Time	.." value="{{ date('h:i') }}">
            </div>
            <div class="new-car-inputs">
                <div class="new-car-inputs-inner">
            ...
            <div class="new-car-inputs">
                ...
                <input  type="text" name="Week" placeholder="Weeks.." value="{{ date("W", strtotime(date('Y-m-d'))) }}">
            </div> 
        </form>
        <button class="AddMaintenance">+ Add Maintenance</button>
    </div>
</div>