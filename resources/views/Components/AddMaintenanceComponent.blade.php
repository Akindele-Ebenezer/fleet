    ...
    <div class="inner">
        ...
        <form class="AddMaintenanceForm">
            ...
            <div class="new-car-inputs">
                ...
                <input  type="text"   name="VehicleNumber_MAINTENANCE" placeholder="PLATE Number	..">
            </div>
            <div class="new-car-inputs">
                <div class="new-car-inputs-inner">
            ...
            <div class="new-car-inputs">
                ...
                <input  type="time" name="ReleaseTime" step='any' placeholder="Release Time	..">
            </div>
            <div class="new-car-inputs">
                <div class="new-car-inputs-inner">
            ...
            <div class="new-car-inputs">
                ...
                <input  type="text" name="Week" placeholder="Weeks..">
            </div> 
