    ...
    <div class="inner">
        ...
        <form class="AddDepositsForm">
            ...
            <div class="new-car-inputs">
                ...
                <input  type="text" list="VehicleNumbers" name="VehicleNumber_DEPOSITS" placeholder="PLATE Number	.." autocomplete="off">
        ...
        <form class="AddMasterCardDepositsForm">
            ...
            <div class="new-car-inputs">
                ...
                <input  type="number" list="CardNumbers" class="CardNumber_MasterCard_DEPOSITS" name="CardNumber_DEPOSITS" placeholder="CARD Number	..">
                <datalist id="CardNumbers">
                    @foreach ($Deposits_MasterCards as $MasterCard)
                        <option class="CardNumbers_Option" value="{{ $MasterCard->CardNumber }}"> 
                    @endforeach
                </datalist>
            </div>
            <div class="new-car-inputs">
