    ...
    <div class="inner">
        ...
        <form class="AddRefuelingForm">
            ...
            <div class="new-car-inputs">
                ...
                <input  type="text" placeholder="PLATE Number	.." name="VehicleNumber_REFUELING">
            </div>
            <div class="new-car-inputs">
                <div class="new-car-inputs-inner">
            ...
            <div class="new-car-inputs">
                ...
                <input  type="time" step='any' name="Time">
            </div>
            <div class="new-car-inputs">
                <div class="new-car-inputs-inner">
                ...
                <input  type="text" placeholder="KMETER	.." name="KMETER">
            </div>
            <div class="new-car-inputs">
                <div class="new-car-inputs-inner">
            ...
            <div class="new-car-inputs">
                ...
                <input  type="text" placeholder="KMLITER.." name="KMLITER">
            </div>  
        </form>
