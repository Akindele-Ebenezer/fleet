<div class="add-repair-form form">
    <div class="inner">
        <div class="error"></div>
        <div class="heading">
            <h1>
        ...
        <form class="AddRepairForm">
            ...
            <div class="new-car-inputs">
                ...
                <input type="text" list="VehicleNumbers" name="VehicleNumber_REPAIR" placeholder="PLATE Number	.." required>
            ...
            <div class="new-car-inputs">
                ...
                <input type="text" name="RepairAction" placeholder="Repair Action	..">
            </div>
            <div class="new-car-inputs">
                <div class="new-car-inputs-inner">
        ...
        <button class="AddRepair">+ Add Repair</button>
    </div>
</div>