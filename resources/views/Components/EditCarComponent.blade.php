<div class="edit-vehicle-form form">
    ...
    <div class="inner">
        <form action="">
            ...
            <div class="new-car-inputs">
                ...
                <input type="text" placeholder="Sub Model..">
            </div>
            <div class="new-car-inputs">
                <div class="new-car-inputs-inner">
            ...
            <div class="new-car-inputs">
                ...
                <input type="text" placeholder="Card No (TOTAL)..">
            </div>
            <div class="new-car-inputs">
                <div class="new-car-inputs-inner">
            ...
            <div class="new-car-inputs">
                ...
                <input type="text" placeholder="Fuel Monthly Buck..">
            </div>
            <div class="new-car-inputs">
                <div class="new-car-inputs-inner">
                ...
                <input type="text" placeholder="Fuel Tank Capacity..">
            </div>
            <div class="new-car-inputs">
                <div class="new-car-inputs-inner">
