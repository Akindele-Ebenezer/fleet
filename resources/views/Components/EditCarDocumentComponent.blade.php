<div class="edit-car-document-form form">
    <div class="inner">
        <div class="heading">
            <h1>
        ...
        <form class="EditCarDocumentForm">
            ...
            <div class="new-car-inputs readonly">
                ...
                <input type="text" class="VehicleNumber_X" name="VehicleNumber">
            </div>  
            <div class="new-car-inputs">
                ...
                <label class="file-x">
                    <input type="file" name="RegistrationCertificate" placeholder="Registration Certificate..">
                    <p>Upload file</p>
                </label>
            </div>   
            <div class="new-car-inputs">
                ...
                <label class="file-x"> 
                    <input type="file" name="DrivingLicence" placeholder="Driving Licence..">
                    <p>Upload file</p>
                </label>
            </div>  
            <div class="new-car-inputs">
                ...
                <label class="file-x"> 
                    <input type="file" name="PUCCertificate" placeholder="PUC Certificate..">
                    <p>Upload file</p>
                </label>
            </div>  
            <div class="new-car-inputs">
                ...
                <label class="file-x"> 
                    <input type="file" name="ProofOfOwnership" placeholder="Proof of ownership..">
                    <p>Upload file</p>
                </label>
            </div>  
            <div class="new-car-inputs">
                ...
                <label class="file-x"></label>
                    <input type="file" name="CertificateOfRoadWorthiness" placeholder="Certificate  Worthiness..">
                    <p>Upload file</p>
                </label>
            </div>  
            <div class="new-car-inputs">
                ...
                <label class="file-x"> 
                    <input type="file" name="InsuranceCertificate" placeholder="Insurance Certificate..">
                    <p>Upload file</p>
                </label>
            </div>   
            <div class="new-car-inputs"> 
            ...
            <div class="new-car-inputs">
                ...
                <input type="date" name="DriverLicenseExpiryDate">
            </div>    
            <div class="new-car-inputs">
                <div class="new-car-inputs-inner">
                    <svg xmlns="http://www.w3.org/2000/svg" height="48" viewBox="0 96 960 960" width="48"><path d="M452 770h56l10-54q20-6 34-15t26-21l62 19 26-54-47-30q4-21 4-39t-4-39l47-30-26-54-62 19q-12-12-26-21t-34-15l-10-54h-56l-10 54q-20 6-34 15t-26 21l-62-19-26 54 47 30q-4 21-4 39t4 39l-47 30 26 54 62-19q12 12 26 21t34 15l10 54Zm28-109q-36 0-60.5-24.5T395 576q0-36 24.5-60.5T480 491q36 0 60.5 24.5T565 576q0 36-24.5 60.5T480 661ZM180 936q-24 0-42-18t-18-42V276q0-24 18-42t42-18h600q24 0 42 18t18 42v600q0 24-18 42t-42 18H180Zm0-60h600V276H180v600Zm0-600v600-600Z"></path></svg>
                ...
                <input type="date" name="VehicleLicenseExpiryDate">
            </div>   
            <div class="new-car-inputs">
                <div class="new-car-inputs-inner">
                    <svg xmlns="http://www.w3.org/2000/svg" height="48" viewBox="0 96 960 960" width="48"><path d="M452 770h56l10-54q20-6 34-15t26-21l62 19 26-54-47-30q4-21 4-39t-4-39l47-30-26-54-62 19q-12-12-26-21t-34-15l-10-54h-56l-10 54q-20 6-34 15t-26 21l-62-19-26 54 47 30q-4 21-4 39t4 39l-47 30 26 54 62-19q12 12 26 21t34 15l10 54Zm28-109q-36 0-60.5-24.5T395 576q0-36 24.5-60.5T480 491q36 0 60.5 24.5T565 576q0 36-24.5 60.5T480 661ZM180 936q-24 0-42-18t-18-42V276q0-24 18-42t42-18h600q24 0 42 18t18 42v600q0 24-18 42t-42 18H180Zm0-60h600V276H180v600Zm0-600v600-600Z"></path></svg>
                ...
                <input type="date" name="ProofOfOwnershipExpiryDate">
            </div>   
            <div class="new-car-inputs">
                <div class="new-car-inputs-inner">
                    <svg xmlns="http://www.w3.org/2000/svg" height="48" viewBox="0 96 960 960" width="48"><path d="M452 770h56l10-54q20-6 34-15t26-21l62 19 26-54-47-30q4-21 4-39t-4-39l47-30-26-54-62 19q-12-12-26-21t-34-15l-10-54h-56l-10 54q-20 6-34 15t-26 21l-62-19-26 54 47 30q-4 21-4 39t4 39l-47 30 26 54 62-19q12 12 26 21t34 15l10 54Zm28-109q-36 0-60.5-24.5T395 576q0-36 24.5-60.5T480 491q36 0 60.5 24.5T565 576q0 36-24.5 60.5T480 661ZM180 936q-24 0-42-18t-18-42V276q0-24 18-42t42-18h600q24 0 42 18t18 42v600q0 24-18 42t-42 18H180Zm0-60h600V276H180v600Zm0-600v600-600Z"></path></svg>
                ...
                <input type="date" name="CertificateOfRoadWorthinessExpiryDate">
            </div>   
            <div class="new-car-inputs">
                <div class="new-car-inputs-inner">
                    <svg xmlns="http://www.w3.org/2000/svg" height="48" viewBox="0 96 960 960" width="48"><path d="M452 770h56l10-54q20-6 34-15t26-21l62 19 26-54-47-30q4-21 4-39t-4-39l47-30-26-54-62 19q-12-12-26-21t-34-15l-10-54h-56l-10 54q-20 6-34 15t-26 21l-62-19-26 54 47 30q-4 21-4 39t4 39l-47 30 26 54 62-19q12 12 26 21t34 15l10 54Zm28-109q-36 0-60.5-24.5T395 576q0-36 24.5-60.5T480 491q36 0 60.5 24.5T565 576q0 36-24.5 60.5T480 661ZM180 936q-24 0-42-18t-18-42V276q0-24 18-42t42-18h600q24 0 42 18t18 42v600q0 24-18 42t-42 18H180Zm0-60h600V276H180v600Zm0-600v600-600Z"></path></svg>
                ...
                <input type="date" name="InsuranceCertificateExpiryDate">
            </div>   
            @csrf
        </form>
