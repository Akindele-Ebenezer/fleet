<div class="edit-credit-card-form form">
    <div class="inner">
        <div class="heading">
            <h1>
        ...
        <form class="EditCreditCardForm">
            ...
            <input type="hidden" name="CarId" class="CreditCardId_X">
        </form>
        <button class="EditCreditCard">+ Edit Credit Card</button>
        <button class="DeleteCreditCard">- Delete Credit Card</button>
    </div>
</div>