...
{{-- @include('Components.AddDeposits_VoucherCardComponent') --}}
{{-- @include('Components.EditDeposits_VoucherCardComponent') --}}

<div class="edit-voucher-card-deposits-form form">
    <div class="inner">
        <div class="heading">
            <h1>
                ...
                Edit Voucher Card Deposit
            </h1>
            <button class="refueling-route">
                Refueling
            </button>
        </div> 
        <form class="EditVoucherCardDepositsForm">
            ...
            <div class="new-car-inputs readonly">
                ...
                <input class="CardNumber_VoucherCard_X" name="CardNumber" type="text">
            </div>
            <div class="new-car-inputs">
                ...
                <input class="Date_VoucherCard_X" name="Date" type="date">
            </div>
            <div class="new-car-inputs readonly">
                <div class="new-car-inputs-inner">
                ...
                <input class="Amount_VoucherCard_X" name="Amount" type="number" placeholder="Amount	..">
            </div>
            <div class="new-car-inputs">
                <div class="new-car-inputs-inner">
                ...
                <input class="Year_VoucherCard_X" name="Year" type="text">
            </div>
            <div class="new-car-inputs">
                <div class="new-car-inputs-inner">
                    <svg xmlns="http://www.w3.org/2000/svg" height="48" viewBox="0 96 960 960" width="48"><path d="M405 782h361V524H405v258ZM140 896q-24 0-42-18t-18-42V316q0-24 18-42t42-18h680q24 0 42 18t18 42v520q0 24-18 42t-42 18H140Zm0-60h680V316H140v520Zm0 0V316v520Z"></path></svg>
                ...
                <input class="Week_VoucherCard_X" name="Week" type="text" placeholder="Week	..">
            </div>
            <div class="new-car-inputs">
                <div class="new-car-inputs-inner">
                ...
                <input class="Month_VoucherCard_X" name="Month" type="text" placeholder="Month	..">
            </div> 
            <input type="hidden" name="DepositsId" class="DepositsId_VoucherCard_X">
        </form>
        <button class="EditVoucherCardDeposits">+ Edit Voucher Card Deposit</button>
        <button class="ReverseVoucherCardDeposits">- Reverse Transaction</button>
    </div>
</div>