    ...
    <div class="inner">
        ...
        <form class="EditRepairForm">
            ...
            <div class="new-car-inputs">
                ...
                <input class="VehicleNumber_X" name="VehicleNumber"  type="text" placeholder="PLATE Number	..">
            </div>
            <div class="new-car-inputs">
                <div class="new-car-inputs-inner">
                ...
                <input class="Date_X" name="Date" type="date">
            </div>
            <div class="new-car-inputs">
                <div class="new-car-inputs-inner">
                ...
                <input class="Time_X" name="Time" type="time" step='any'>
            </div>
            <div class="new-car-inputs">
                <div class="new-car-inputs-inner">
                ...
                <input class="RepairAction_X" name="RepairAction" type="text" placeholder="Repair Action	..">
            </div>
            <div class="new-car-inputs">
                <div class="new-car-inputs-inner">
                ...
                <input class="ReleaseDate_X" name="ReleaseDate" type="date">
            </div>
            <div class="new-car-inputs">
                <div class="new-car-inputs-inner">
                    <svg xmlns="http://www.w3.org/2000/svg" height="48" viewBox="0 96 960 960" width="48"><path d="M405 782h361V524H405v258ZM140 896q-24 0-42-18t-18-42V316q0-24 18-42t42-18h680q24 0 42 18t18 42v520q0 24-18 42t-42 18H140Zm0-60h680V316H140v520Zm0 0V316v520Z"></path></svg>
                ...
                <input class="ReleaseTime_X" name="ReleaseTime" type="time" step='any' placeholder="Release Time	..">
            </div>
            <div class="new-car-inputs">
                <div class="new-car-inputs-inner">
                ...
                <input class="Cost_X" name="Cost" type="number" placeholder="Cost	..">
            </div>
            <div class="new-car-inputs">
                <div class="new-car-inputs-inner">
                ...
                <input class="InvoiceNumber_X" name="InvoiceNumber" type="text" placeholder="Invoice No..">
            </div>
            <div class="new-car-inputs">
                <div class="new-car-inputs-inner">
            ...
            <input type="hidden" name="RepairId" class="RepairId_X">
        </form>
        <button class="EditRepair">+ Edit Repair</button>
        <button class="DeleteRepair">- Delete Repair</button>
    </div>
</div>