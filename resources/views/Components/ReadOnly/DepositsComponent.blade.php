<div class="monthly-deposits-readonly readonly form">
    <div class="inner">
        <div class="heading">
            <h1>
        ...
        <form action="">
            ...
            <div class="new-car-inputs">
                ...
                <input class="CardNumber_X" type="text">
            </div>
            <div class="new-car-inputs">
                <div class="new-car-inputs-inner">
            ...
            <div class="new-car-inputs">
                ...
                <input class="Week_X" type="text" placeholder="Week	..">
            </div>
            <div class="new-car-inputs">
                <div class="new-car-inputs-inner">
        ...
        <button class="PrintDeposit">+ Print Monthly Deposits</button>
    </div>
</div>